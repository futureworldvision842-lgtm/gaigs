const CACHE='gaigs-v30-public-release';const FILES=['./','./index.html','./styles.css?v=30','./vendor/ethers.umd.min.js','./app.js','./platform-core.js?v=23','./social-logic.js','./social-core.js?v=23','./community-logic.js','./constitution-logic.js','./community-admin.js','./governance-logic.js','./access-logic.js','./governance-core.js','./operations-core.js','./humanity-lab-core.js','./jarvis-core.js','./map-core.js','./emergency-core.js','./notifications-core.js','./messaging-core.js','./marketplace-logic.js','./project-logic.js','./marketplace-core.js','./dashboard-core.js?v=23','./civic-core.js','./enterprise-news-core.js','./project-controls-core.js','./dao-core.js','./policy-core.js','./creator-library-data.js?v=24','./mission-library-core.js?v=30','./manifest.json','./icon-192.png','./icon-512.png','./icon-maskable.png'];
